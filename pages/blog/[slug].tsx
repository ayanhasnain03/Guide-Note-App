        ...
        <div className="bg-[#0b1215] text-white">
          <div className="px-6 py-16 pt-16 pb-48 mx-auto -mb-48 text-center md:pb-96 md:-mb-96">
            <div className="max-w-3xl mx-auto">
              <div className="sm:flex items-center justify-center mb-2 space-x-2 text-sm text-gray-400">
                <div>{publishedOn}</div>
                {publishedOn !== modifiedDate && (
                  <>
                    <span className="sm:block hidden">•</span>
                    <span>Updated on {modifiedDate}</span>
                  </>
                )}
              </div>
              <div className="font-extrabold tracking-tight text-white text-2xl sm:text-4xl">
                {title}
              </div>
              <div className="max-w-3xl mx-auto mt-3 text-xl leading-8 text-gray-300 sm:mt-4">
                {summary}
              </div>
            </div>
          </div>
          ...
          <div className="py-12 border-t border-[#003300]">
            {' '}
            {/* Darker terminal color */}
            <Container>
              <div className="flex items-center justify-between my-8">
                <div className="text-3xl font-bold text-white">Latest articles</div>
                <Link href="/">
